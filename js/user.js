...
Tonyu.klass.define({
    ...
    return {
      ...
      nextScene :function _trc_MainProcLibs_nextScene(flag) {
        ...
        if (Tonyu.globals.$norma<=0) {
          _this.loadPage(Tonyu.classes.user.ClearScreen);
        }
      ...
      fiber$nextScene :function _trc_MainProcLibs_f_nextScene(_thread,flag) {
        ...
        _thread.enter(function _trc_MainProcLibs_ent_nextScene(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
              if (!(Tonyu.globals.$norma<=0)) { __pc=2     ; break; }
              _this.fiber$loadPage(_thread, Tonyu.classes.user.ClearScreen);
              __pc=1;return;
            case 1:
              
            case 2     :
              
              if (!(Tonyu.globals.$stageList.length<=0)) { __pc=4     ; break; }
            ...
            case 4     :
              ...
              if (!(Tonyu.globals.$bossList.length<=0)) { __pc=6     ; break; }
            ...
            case 6     :
              ...
              if (!(Tonyu.globals.$stage<Tonyu.globals.$stageList.length-1)) { __pc=7     ; break; }
              Tonyu.globals.$stage++;
              __pc=10    ;break;
            case 7     :
              if (Tonyu.globals.$difficulty!==Tonyu.globals.$bossDifficulty) {
  ...
  decls: {"methods":{"main":{"nowait":false},"init":{"nowait":false},"spawnItems":{"nowait":false},"rotItems":{"nowait":false},"shuffle":{"nowait":false},"nextScene":{"nowait":false}},"fields":{"rand":{},"spawn":{},"nowBaseItem":{},"badItem0":{},"badItem1":{},"coolGuySpawn":{},"ceiling":{},"leftWall":{},"rightWall":{},"ui":{},"player":{},"i":{},"arr":{},"n":{},"temp":{}}}
});
Tonyu.klass.define({
...
Tonyu.klass.define({
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"cr":{},"bg":{},"countDown":{},"frame":{},"goodItemScaleX":{},"badItemScaleX":{},"item1":{},"item2":{},"item3":{},"badItem":{},"badItemStand":{},"offsetFollowMotion":{},"shakeMotion":{},"roundTripMotion":{},"rocketItem":{},"badItemPos":{},"shakePos":{},"roundTripPos":{}}}
});
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_SentakuScene_main() {
        ...
        _this.badItemList=[];
        _this.badItemList[0]=new Tonyu.classes.user.SentakuItem({x: Tonyu.globals.$W*0.2,y: Tonyu.globals.$H*0.5,moveX: Tonyu.globals.$W*0.2,moveY: Tonyu.globals.$H*0.5,itemType: 0,badItem: true,density: 0.1,restitution: 0.1,scaleX: _this.badItemScale,sp: _this.sp,sentakuKi: _this.sentaku});
        _this.badItemList[1]=new Tonyu.classes.user.SentakuItem({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,moveX: Tonyu.globals.$W*0.5,moveY: Tonyu.globals.$H*0.5,itemType: 1,badItem: true,density: 0.1,restitution: 0.1,scaleX: _this.badItemScale,sp: _this.sp,sentakuKi: _this.sentaku});
        _this.badItemList[2]=new Tonyu.classes.user.SentakuItem({x: Tonyu.globals.$W*0.8,y: Tonyu.globals.$H*0.5,moveX: Tonyu.globals.$W*0.8,moveY: Tonyu.globals.$H*0.5,itemType: 2,badItem: true,density: 0.1,restitution: 0.1,scaleX: _this.badItemScale,sp: _this.sp,sentakuKi: _this.sentaku});
        ...
        while (true) {
          ...
          _this.badItemList.map((function anonymous_1799(item) {
...
Tonyu.klass.define({
      ...
      main :function _trc_SentakuItem_main() {
        ...
        while (true) {
          ...
          if (_this.crashTo(Tonyu.classes.user.SentakuKi)) {
            _this.houriKomare=1;
            new Tonyu.classes.user.CoolSentakuItem({y: Tonyu.globals.$H*0.15,x: 0,sentakuKi: _this.sentakuKi,itemType: _this.itemType,badItem: false,alpha: 0});
            _this.die();
  ...
  decls: {"methods":{"main":{"nowait":false},"moving":{"nowait":false},"crash":{"nowait":false}},"fields":{"sp":{},"frame":{},"futtobi":{},"houriKomare":{},"moveX":{},"moveY":{},"YHirei":{},"YTobioriFirstPos":{},"sentakuKi":{},"bullet":{}}}
});
Tonyu.klass.define({
    ...
    return {
      main :function _trc_Player_main() {
        ...
        while (true) {
          ...
          if (! _this.notMove) {
            _this.x+=Tonyu.globals.$touches[0].vx;
            if (_this.getkey("a")&&_this.x>0) {
              _this.x+=- _this.speed;
            ...
            if (_this.getkey("d")&&_this.x<Tonyu.globals.$W) {
              _this.x+=_this.speed;
        ...
        _thread.enter(function _trc_Player_ent_main(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 9     :
              ...
              if (!(Tonyu.globals.$touches[0].touched)) { __pc=11    ; break; }
              _this.fiber$retry(_thread);
              __pc=10;return;
            case 10:
...
Tonyu.klass.define({
        ...
        _thread.enter(function _trc_CoolSentakuItem_ent_main(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 2:
              ...
              if (!(_this.frame>100)) { __pc=4     ; break; }
              _this.alpha=255;
              _this.fiber$foll(_thread);
              __pc=3;return;
            case 3:
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"sentakuKi":{},"frame":{}}}
});
Tonyu.klass.define({
