...
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_GetText_main() {
        "use strict";
        var _this=this;
        
        _this.textType=["イカす!!","Cool!!","シブい!!"];
        _this.firstPosX;
        _this.firstPosY;
        _this.l=new Tonyu.classes.kernel.Label({text: _this.textType[_this.rnd(3)],size: 30,x: _this.firstPosX,y: _this.firstPosY,fillStyle: "blue"});
        _this.i=255;for (; _this.i>=0 ; _this.i-=10) {
          Tonyu.checkLoop();
          {
            _this.l.y+=- 1;
            _this.l.alpha=_this.i;
            _this.update();
          }
        }
        _this.die();
      },
      fiber$main :function _trc_GetText_f_main(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_GetText_ent_main(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"textType":{},"firstPosX":{},"firstPosY":{},"l":{},"i":{}}}
});
Tonyu.klass.define({
  fullName: 'user.HP',
  shortName: 'HP',
...
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      ...
      screenInit :function _trc_MainProcLibs_screenInit() {
        "use strict";
        var _this=this;
        
        Tonyu.globals.$fontColor="#88001b";
        Tonyu.globals.$BGColor="#e9d8d4";
      ...
      fiber$screenInit :function _trc_MainProcLibs_f_screenInit(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
      ...
      fiber$init :function _trc_MainProcLibs_f_init(_thread) {
        ...
        _thread.enter(function _trc_MainProcLibs_ent_init(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
              _this.fiber$screenInit(_thread);
              __pc=1;return;
            case 1:
      ...
      nextScene :function _trc_MainProcLibs_nextScene(flag) {
        ...
        if (Tonyu.globals.$norma<=0) {
          _this.retry();
          _this.loadPage(Tonyu.classes.user.ED);
        ...
        _thread.enter(function _trc_MainProcLibs_ent_nextScene(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 1:
              ...
              _this.fiber$loadPage(_thread, Tonyu.classes.user.ED);
              __pc=2;return;
            case 2:
  ...
  decls: {"methods":{"main":{"nowait":false},"retry":{"nowait":false},"screenInit":{"nowait":false},"init":{"nowait":false},"spawnItems":{"nowait":false},"rotItems":{"nowait":false},"shuffle":{"nowait":false},"nextScene":{"nowait":false}},"fields":{"rand":{},"spawn":{},"nowBaseItem":{},"badItem0":{},"badItem1":{},"coolGuySpawn":{},"ceiling":{},"leftWall":{},"rightWall":{},"ui":{},"player":{},"i":{},"arr":{},"n":{},"temp":{}}}
});
Tonyu.klass.define({
  fullName: 'user.OP',
  shortName: 'OP',
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_OP_main() {
        ...
        _this.screenInit();
        new Tonyu.classes.kernel.FadeEffect({type: "in",fillStyle: Tonyu.globals.$BGColor});
        _this.BG=new Tonyu.classes.kernel.Actor({p: Tonyu.globals.$pat_op1,x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5});
        Tonyu.globals.$panel.fillStyle=Tonyu.globals.$BGColor;
        Tonyu.globals.$panel.alpha=120;
        Tonyu.globals.$panel.fillRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        _this.text=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,fillStyle: Tonyu.globals.$fontColor,size: 30,zOrder: - 10});
        _this.clickSE=Tonyu.globals.$se_pa;
        _this.hintText=new Tonyu.classes.kernel.Label({text: "タッチorクリックで進める",x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.8,fillStyle: Tonyu.globals.$fontColor,size: 20,zOrder: - 11});
        _this.parallel("tenmetu");
        ;
        
        ;
        
        Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_111,true);
        _this.text.text="彼はどこにでも居る\nおっさん。";
        _this.waitTouch();
        _this.text.text="彼は日課の散歩を\n楽しんでいた。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        new Tonyu.classes.kernel.FadeEffect({type: "in",fillStyle: Tonyu.globals.$BGColor});
        _this.BG.p=Tonyu.globals.$pat_op2;
        _this.text.text="おっさんは\nふと気がついた。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        _this.text.text="隣で女子高生が\n歩いている。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        _this.text.text="女子高生は\nこう言った。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        _this.BG.scaleX=1.5;
        _this.BG.align="-80 -170";
        _this.text.text="「あそこを歩いてる\nおっさんさー、";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        _this.text.text="そうそうw\nあのロン毛のおっさん。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        _this.BG.scaleX=1.8;
        _this.text.text="あのおっさん、\nまじでぇ。";
        Tonyu.globals.$sound.playSE(_this.clickSE);
        _this.waitTouch();
        Tonyu.globals.$sound.pauseBGM();
        _this.text.text="だ";
        _this.text.size=60;
        _this.BG.scaleX=2;
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_doko);
        ...
        _this.waitTouch();
        _this.text.hide();
        _this.BG.p=Tonyu.globals.$pat_op1;
        _this.BG.align="center center 0 -180";
        _this.update();
        _this.updateEx(120);
        _this.BG.scaleX=5;
        _this.BG.p=Tonyu.globals.$pat_op3;
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_shock1);
        _this.update();
        _this.updateEx(120);
        Tonyu.globals.$sound.resumeBGM();
        new Tonyu.classes.kernel.FadeEffect({type: "out",fillStyle: "black"});
        _this.text.show();
        _this.text.fillStyle="white";
        _this.text.size=50;
        _this.text.text="おっさんは\n決意した。";
        _this.hintText.fillStyle="white";
        _this.waitTouch();
        _this.text.size=30;
        _this.text.text="「俺を拒絶した\nこの世界、俺は";
        _this.waitTouch();
        _this.text.size=60;
        _this.text.text="許しはしない";
        _this.waitTouch();
        _this.text.size=30;
        _this.text.text="首を洗って\n待ってろ。";
        _this.waitTouch();
        _this.text.size=20;
        _this.text.text="お天道様も\nぶったまげる";
        _this.waitTouch();
        _this.text.size=60;
        _this.text.text="イカすコーデ";
        _this.waitTouch();
        _this.text.size=20;
        _this.text.text="キメてやるからな。」";
        _this.waitTouch();
        _this.text.size=30;
        _this.text.text="こうしておっさんの";
        _this.waitTouch();
        _this.text.text="コーデ極める\n茨の道が始まった。";
        _this.waitTouch();
        _this.BG.die();
        _this.text.die();
        Tonyu.globals.$panel.clearRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
      ...
      tenmetu :function _trc_OP_tenmetu() {
        "use strict";
        var _this=this;
        var frame;
        var show;
      ...
      fiber$tenmetu :function _trc_OP_f_tenmetu(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_OP_ent_tenmetu(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
      ...
      waitTouch :function _trc_OP_waitTouch() {
        "use strict";
        var _this=this;
      ...
      fiber$waitTouch :function _trc_OP_f_waitTouch(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_OP_ent_waitTouch(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
  ...
  decls: {"methods":{"main":{"nowait":false},"tenmetu":{"nowait":false},"waitTouch":{"nowait":false}},"fields":{"BG":{},"clickSE":{},"hintText":{}}}
});
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      ...
      retryText :function _trc_Retry_retryText() {
        ...
        label = new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.3,text: "激ダサ!!",size: 50,fillStyle: "red"});
...
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_Tutorial_main() {
        ...
        _this.mes="画面をスワイプorマウス移動で\n青い服を取ろう!\nそれはめっちゃイカす\nクールな服だ!\n赤い服は取るのをよそう!\n激ダサな服なので\n1つでも取れば一発KOだぞ!!\n赤い服を3回以上取れば\n残基が切れてGameOverなので\n気をつけよう!\n\n\n\nタッチorクリックで戻る";
        Tonyu.globals.$panel.fillStyle=Tonyu.globals.$BGColor;
        Tonyu.globals.$panel.fillRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        _this.text=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.3,fillStyle: Tonyu.globals.$fontColor,text: _this.mes,size: 25,zOrder: - 10});
        _this.updateEx(30);
        while (true) {
          Tonyu.checkLoop();
          if (Tonyu.globals.$touches[0].touched===1) {
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"t":{},"mes":{}}}
});
Tonyu.klass.define({
  fullName: 'user.Rogo',
  shortName: 'Rogo',
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_UI_main() {
        ...
        _this.scoreLabel=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.635,y: Tonyu.globals.$H*0.1,template: "残機:$life  ノルマ:$norma",size: Tonyu.globals.$W*0.07});
        while (true) {
          Tonyu.checkLoop();
          _this.update();
      ...
      main :function _trc_Player_main() {
        ...
        while (true) {
          ...
          if (_this.ci&&_this.apeealTime>- 1) {
            _this.existItem = _this.followItemList.filter((function anonymous_1811(item) {
            ...
            if (_this.existItem.length<=0) {
              if (_this.ci.badItem===false) {
                ...
                new Tonyu.classes.user.GetText({firstPosX: _this.x,firstPosY: _this.y});
          ...
          if (_this.apeealTime<- 1) {
            ...
            if (_this.apeealTime<=- 50) {
              ...
              if (Tonyu.globals.$life>0) {
                ...
                _this.loadPage(Tonyu.classes.user.GameOver);
              }
        ...
        _thread.enter(function _trc_Player_ent_main(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 5     :
              ...
              if (!(_this.apeealTime===- 1)) { __pc=7     ; break; }
              Tonyu.globals.$sound.playSE(Tonyu.globals.$se_gua);
              Tonyu.globals.$sound.playSE(Tonyu.globals.$se_syaki);
              Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_40);
              _this.all(Tonyu.classes.user.Items).die();
            ...
            case 10    :
              ...
              if (!(_this.apeealTime<- 1)) { __pc=16    ; break; }
              _this.x=Tonyu.globals.$W*0.5;
              _this.y=Tonyu.globals.$H*0.5;
              _this.apeealTime--;
              if (_this.apeealTime%6===0) {
              ...
              if (!(_this.apeealTime<=- 50)) { __pc=15    ; break; }
              Tonyu.globals.$life--;
              if (!(Tonyu.globals.$life>0)) { __pc=12    ; break; }
              _this.fiber$setApeealEnd(_thread, true);
              __pc=11;return;
            case 11:
              ...
              __pc=14    ;break;
            case 12    :
              _this.fiber$loadPage(_thread, Tonyu.classes.user.GameOver);
              __pc=13;return;
            case 13:
            ...
            case 17:
              ...
              if (!(_this.bodyFlag)) { __pc=19    ; break; }
            ...
            case 18:
              ...
              __pc=22    ;break;
            case 19    :
              if (!(_this.bodyFlag)) { __pc=21    ; break; }
...
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_ED_main() {
        "use strict";
        var _this=this;
        
        _this.screenInit();
        new Tonyu.classes.kernel.FadeEffect({type: "in",fillStyle: Tonyu.globals.$BGColor});
        _this.BG=new Tonyu.classes.kernel.Actor({p: Tonyu.globals.$pat_ed1,x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5});
        Tonyu.globals.$panel.fillStyle=Tonyu.globals.$BGColor;
        Tonyu.globals.$panel.alpha=120;
        Tonyu.globals.$panel.fillRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        _this.text=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,fillStyle: Tonyu.globals.$fontColor,size: 30,zOrder: - 10});
        ...
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_syaki);
        Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_40,true);
        _this.text.text="おっさんはついに\nコーディネートを\n極めた。";
        _this.waitTouch();
        _this.text.text="誰もがうらやむ、\nそのファッションセンスに\n民衆は虜となる。";
        _this.waitTouch();
        _this.BG.align="center center 0 -180";
        _this.BG.scaleX=2;
        _this.text.text="おっさんは満足した。";
        _this.waitTouch();
        _this.text.text="己の目標を\nついに成し遂げたと。";
        _this.BG.scaleX=2.5;
        _this.text.text="民衆は完全に\n俺の存在に屈服したと。\nそう悟った。";
        _this.waitTouch();
        Tonyu.globals.$sound.stopBGM();
        _this.BG.p=Tonyu.globals.$pat_ed2;
        _this.BG.scaleX=4;
        _this.BG.align="center";
        _this.text.text="だがその栄光は\n長く続かない。";
        _this.waitTouch();
        _this.BG.scaleX=3;
        _this.text.text="そう、あの男が、";
        _this.waitTouch();
        _this.BG.scaleX=1;
        _this.text.text="ダンディまつぢが\n目の前に現れたのだ。";
        _this.waitTouch();
        _this.text.hide();
        _this.hintText.hide();
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_shock1);
        _this.BG.p=Tonyu.globals.$pat_ed2_5;
        _this.updateEx(120);
        _this.text.show();
        _this.hintText.show();
        Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_111,true);
        _this.BG.p=Tonyu.globals.$pat_ed3;
        ...
        _this.hintText.fillStyle="white";
        _this.text.size=55;
        _this.text.text="「なんてこった。";
        _this.waitTouch();
        _this.text.size=25;
        _this.text.text="奴のファッションは";
        _this.waitTouch();
        _this.text.size=65;
        _this.text.text="ビックバン級";
        _this.waitTouch();
        _this.text.size=25;
        _this.text.text="俺は頂点に\n上り詰めたと\n思っていた。";
        _this.waitTouch();
        _this.text.size=20;
        _this.text.text="だが違った";
        _this.waitTouch();
        _this.text.size=15;
        _this.text.text="奴に比べりゃ俺なんて";
        _this.waitTouch();
        _this.text.size=10;
        _this.text.text="ミジンコ";
        _this.waitTouch();
        _this.text.size=15;
        _this.text.text="みてえなモンだぜ。";
        _this.waitTouch();
        _this.text.size=30;
        _this.text.text="やってやるぜ。\nダンディまつぢ!!";
        _this.waitTouch();
        _this.text.size=55;
        _this.text.text="俺は\nアンタを越える";
        _this.waitTouch();
        _this.text.size=25;
        _this.text.text="俺はアンタを越えて。";
        _this.waitTouch();
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_shock1);
        _this.text.size=55;
        _this.text.text="頂点に返り咲く!!";
        _this.waitTouch();
        _this.text.size=30;
        _this.text.text="こうしておっさんの\n新たなる。";
        _this.waitTouch();
        _this.text.text="コーデを極める、\n修羅の道が幕を開ける…。";
        _this.waitTouch();
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_syaki);
        Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_40,true);
        _this.text.hide();
        _this.hintText.hide();
        Tonyu.globals.$panel.clearRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        new Tonyu.classes.kernel.FadeEffect({type: "in",$fillStyle: Tonyu.globals.$BGColor,duration: 10});
        _this.updateEx(120);
        Tonyu.globals.$panel.fillStyle=Tonyu.globals.$BGColor;
        Tonyu.globals.$panel.alpha=120;
        Tonyu.globals.$panel.fillRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        ...
        _this.hintText.fillStyle=Tonyu.globals.$fontColor;
        _this.text.text="続かない。";
        _this.waitTouch();
        Tonyu.globals.$panel.fillStyle="black";
        Tonyu.globals.$panel.alpha=255;
        Tonyu.globals.$panel.clearRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
      ...
      fiber$main :function _trc_ED_f_main(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_ED_ent_main(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
      ...
      tenmetu :function _trc_ED_tenmetu() {
        "use strict";
        var _this=this;
        var frame;
        var show;
        ...
        while (1) {
          ...
          if (frame%30===0) {
            if (show===0) {
              show=1;
              _this.hintText.alpha=255;
              
            } else {
              if (show===1) {
                show=0;
                _this.hintText.alpha=0;
      ...
      fiber$tenmetu :function _trc_ED_f_tenmetu(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_ED_ent_tenmetu(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
      ...
      waitTouch :function _trc_ED_waitTouch() {
        "use strict";
        var _this=this;
      ...
      fiber$waitTouch :function _trc_ED_f_waitTouch(_thread) {
        "use strict";
        var _this=this;
        //var _arguments=Tonyu.A(arguments);
        var __pc=0;
        ...
        _thread.enter(function _trc_ED_ent_waitTouch(_thread) {
          if (_thread.lastEx) __pc=_thread.catchPC;
          for(var __cnt=100 ; __cnt--;) {
            switch (__pc) {
            case 0:
...
Tonyu.klass.define({
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_GameOver_main() {
        ...
        _this.angle=0;
        _this.frame=0;
        _this.pleaseClickTextShow=false;
        Tonyu.globals.$panel.fillStyle=Tonyu.globals.$BGColor;
        Tonyu.globals.$panel.fillRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
        Tonyu.globals.$panel.alpha=180;
        Tonyu.globals.$sound.playSE(Tonyu.globals.$se_gua);
        Tonyu.globals.$sound.playBGM(Tonyu.globals.$se_k_130,true);
        _this.BG=new Tonyu.classes.kernel.Actor({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,p: Tonyu.globals.$pat_guruguru,scaleX: 2});
        _this.gameOverTextSize=30;
        _this.gameOverText=new Tonyu.classes.kernel.Label({text: "げーむおーばー",size: _this.gameOverTextSize,x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,fillStyle: Tonyu.globals.$fontColor,zOrder: - 11});
        _this.ossan=new Tonyu.classes.kernel.Actor({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.5,p: Tonyu.globals.$pat_ojisan_damage,scaleX: 0.8});
        _this.pleaseClickText=new Tonyu.classes.kernel.Label({text: "タッチorクリックで再挑戦",x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.7,fillStyle: Tonyu.globals.$fontColor,size: 20,zOrder: - 11});
        while (1) {
          Tonyu.checkLoop();
          _this.angle+=10;
          _this.gameOverText.size=_this.gameOverTextSize+_this.cos(_this.angle)*4;
          _this.ossan.rotation=_this.angle;
          _this.ossan.scaleX=0.5+_this.cos(_this.angle)*0.25;
          _this.BG.rotation=- _this.frame;
          if (_this.frame%30===0) {
            _this.pleaseClickTextShow=! _this.pleaseClickTextShow;
          }
          _this.pleaseClickTextShow?_this.pleaseClickText.show():_this.pleaseClickText.hide();
          if (Tonyu.globals.$touches[0].touched===1) {
            Tonyu.globals.$panel.clearRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
            Tonyu.globals.$panel.alpha=255;
            _this.retry();
        ...
        _thread.enter(function _trc_GameOver_ent_main(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 2:
              ...
              _this.pleaseClickTextShow?_this.pleaseClickText.show():_this.pleaseClickText.hide();
              if (!(Tonyu.globals.$touches[0].touched===1)) { __pc=5     ; break; }
              Tonyu.globals.$panel.clearRect(0,0,Tonyu.globals.$W,Tonyu.globals.$H);
              Tonyu.globals.$panel.alpha=255;
              _this.fiber$retry(_thread);
              __pc=3;return;
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"angle":{},"frame":{},"pleaseClickTextShow":{},"BG":{},"gameOverTextSize":{},"gameOverText":{},"ossan":{},"pleaseClickText":{}}}
});
Tonyu.klass.define({
  fullName: 'user.Main',
  shortName: 'Main',
  ...
  methods: function (__superClass) {
    return {
      main :function _trc_Main_main() {
        ...
        _this.titleText=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.3,text: "おっさんコーディネート",size: 30,fillStyle: Tonyu.globals.$fontColor});
        _this.verText=new Tonyu.classes.kernel.Label({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.4,text: "ver.8",size: 20,fillStyle: Tonyu.globals.$fontColor});
        _this.OPButton=new Tonyu.classes.kernel.Button({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.8,fillStyle: Tonyu.globals.$BGColor,strokeStyle: Tonyu.globals.$fontColor,text: "あらまし",width: 180,height: 50});
        _this.tutorialButton=new Tonyu.classes.kernel.Button({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.7,align: "left",fillStyle: Tonyu.globals.$BGColor,strokeStyle: Tonyu.globals.$fontColor,text: "チュートリアル",width: 290,height: 50});
        _this.startButton=new Tonyu.classes.kernel.Button({x: Tonyu.globals.$W*0.5,y: Tonyu.globals.$H*0.6,align: "left",fillStyle: Tonyu.globals.$BGColor,strokeStyle: Tonyu.globals.$fontColor,text: "始める",width: 140,height: 50});
        while (true) {
          Tonyu.checkLoop();
          if (_this.startButton.clicked===1) {
            Tonyu.globals.$sound.playSE(Tonyu.globals.$se_get);
            new Tonyu.classes.kernel.FadeEffect({type: "in",fillStyle: Tonyu.globals.$BGColor,page: Tonyu.classes.user.Start});
            
          }
          if (_this.tutorialButton.clicked===1) {
            new Tonyu.classes.user.Tutorial;
          }
          if (_this.OPButton.clicked===1) {
        ...
        _thread.enter(function _trc_Main_ent_main(_thread) {
          ...
          for(var __cnt=100 ; __cnt--;) {
            ...
            case 2:
              ...
              if (!(_this.OPButton.clicked===1)) { __pc=4     ; break; }
  ...
  decls: {"methods":{"main":{"nowait":false}},"fields":{"titleText":{},"verText":{},"OPButton":{},"tutorialButton":{},"startButton":{}}}
});
Tonyu.klass.define({
